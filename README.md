...
This PHP package is automatically generated by the [OpenAPI Generator](https://openapi-generator.tech) project:ankjsd
...
```json
{
  "repositories": [
    {
      "type": "vcs",
      "url": "https://github.com/everyday/gmodstore-sdk.git"
    }
  ],
  "require": {
    "everyday/gmodstore-sdk": "*@dev"
  }
}
```
