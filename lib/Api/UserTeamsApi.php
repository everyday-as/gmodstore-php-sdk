...
class UserTeamsApi
{
    ...
    public function listUserTeamsWithHttpInfo($userId, $with = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Everyday\GmodStore\Sdk\Model\TeamListResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Everyday\GmodStore\Sdk\Model\TeamListResponse', []),
     ...
     */
    public function listUserTeamsRequest($userId, $with = null)
    {
