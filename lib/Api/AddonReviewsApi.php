...
class AddonReviewsApi
{
    ...
    /**
     * Operation addonsAddonIdReviewsGet
     *
    ...
    {
        list($response) = $this->addonsAddonIdReviewsGetWithHttpInfo($addon_id, $with);
        return $response;
    }

    /**
     * Operation addonsAddonIdReviewsGetWithHttpInfo
     *
     * Fetch all the reviews of an addon
     *
     * @param  int $addon_id Id of the addon (required)
    ...
    /**
     * Operation addonsAddonIdReviewsGetAsync
     *
     * Fetch all the reviews of an addon
     *
     * @param  int $addon_id Id of the addon (required)
     ...
     */
    public function addonsAddonIdReviewsGetAsync($addon_id, $with = null)
    {
        return $this->addonsAddonIdReviewsGetAsyncWithHttpInfo($addon_id, $with)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation addonsAddonIdReviewsGetAsyncWithHttpInfo
     *
     * Fetch all the reviews of an addon
     *
     * @param  int $addon_id Id of the addon (required)
    ...
    /**
     * Create request for operation 'addonsAddonIdReviewsGet'
     *
     * @param  int $addon_id Id of the addon (required)
     * @param  string[] $with The relations you want to fetch with the AddonReview schema (optional)
     *
     ...
     */
    protected function addonsAddonIdReviewsGetRequest($addon_id, $with = null)
    {
        // verify the required parameter 'addon_id' is set
        if ($addon_id === null || (is_array($addon_id) && count($addon_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $addon_id when calling addonsAddonIdReviewsGet'
            );
        }
    ...
    /**
     * Operation addonsAddonIdReviewsReviewIdGet
     *
    ...
    {
        list($response) = $this->addonsAddonIdReviewsReviewIdGetWithHttpInfo($addon_id, $review_id, $with);
        return $response;
    }

    /**
     * Operation addonsAddonIdReviewsReviewIdGetWithHttpInfo
     *
     * Fetch a review of an addon
     *
     * @param  int $addon_id Id of the addon (required)
    ...
    /**
     * Operation addonsAddonIdReviewsReviewIdGetAsync
     *
     * Fetch a review of an addon
     *
     * @param  int $addon_id Id of the addon (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function addonsAddonIdReviewsReviewIdGetAsync($addon_id, $review_id, $with = null)
    {
        return $this->addonsAddonIdReviewsReviewIdGetAsyncWithHttpInfo($addon_id, $review_id, $with)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation addonsAddonIdReviewsReviewIdGetAsyncWithHttpInfo
     *
     * Fetch a review of an addon
     *
     * @param  int $addon_id Id of the addon (required)
    ...
    /**
     * Create request for operation 'addonsAddonIdReviewsReviewIdGet'
     *
     * @param  int $addon_id Id of the addon (required)
     * @param  int $review_id Id of the review (required)
     * @param  string[] $with The relations you want to fetch with the AddonReview schema (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function addonsAddonIdReviewsReviewIdGetRequest($addon_id, $review_id, $with = null)
    {
        // verify the required parameter 'addon_id' is set
        if ($addon_id === null || (is_array($addon_id) && count($addon_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $addon_id when calling addonsAddonIdReviewsReviewIdGet'
            );
        }
        // verify the required parameter 'review_id' is set
        if ($review_id === null || (is_array($review_id) && count($review_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $review_id when calling addonsAddonIdReviewsReviewIdGet'
            );
        }
