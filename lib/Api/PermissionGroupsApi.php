...
class PermissionGroupsApi
{
    ...
    public function listPermissionGroupsWithHttpInfo()
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Everyday\GmodStore\Sdk\Model\PermissionGroupListResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Everyday\GmodStore\Sdk\Model\PermissionGroupListResponse', []),
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Everyday\GmodStore\Sdk\Model\PermissionGroupListResponse',
     ...
     */
    public function listPermissionGroupsRequest()
    {
