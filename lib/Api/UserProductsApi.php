...
/**
 * UserProductsApi Class Doc Comment
 *
 * @category Class
 * @package  Everyday\GmodStore\Sdk
 * @author   OpenAPI Generator team
...
class UserProductsApi
{
     ...
     */
    public function listUserProducts($user, $cursor = null, $filter = null)
    {
        list($response) = $this->listUserProductsWithHttpInfo($user, $cursor, $filter);
        return $response;
    }

    /**
     * Operation listUserProductsWithHttpInfo
     *
     * List all the specified user&#39;s products
     *
     ...
     */
    public function listUserProductsWithHttpInfo($user, $cursor = null, $filter = null)
    {
        $request = $this->listUserProductsRequest($user, $cursor, $filter);
    ...
    /**
     * Operation listUserProductsAsync
     *
     * List all the specified user&#39;s products
     *
     * @param  string $user (required)
     ...
     */
    public function listUserProductsAsync($user, $cursor = null, $filter = null)
    {
        return $this->listUserProductsAsyncWithHttpInfo($user, $cursor, $filter)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation listUserProductsAsyncWithHttpInfo
     *
     * List all the specified user&#39;s products
     *
     * @param  string $user (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listUserProductsAsyncWithHttpInfo($user, $cursor = null, $filter = null)
    {
        $returnType = 'object';
        $request = $this->listUserProductsRequest($user, $cursor, $filter);
    ...
    /**
     * Create request for operation 'listUserProducts'
     *
     * @param  string $user (required)
     * @param  string $cursor The cursor from which to return paginated results starting after (optional)
     * @param  \Everyday\GmodStore\Sdk\Model\ProductFilter $filter Filter the results (optional)
     ...
     */
    public function listUserProductsRequest($user, $cursor = null, $filter = null)
    {
        // verify the required parameter 'user' is set
        if ($user === null || (is_array($user) && count($user) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $user when calling listUserProducts'
            );
        }

        $resourcePath = '/api/v3/users/{user}/products';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
