...
class UserBansApi
{
    ...
    public function listUserBansWithHttpInfo($userId)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Everyday\GmodStore\Sdk\Model\UserBanListResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Everyday\GmodStore\Sdk\Model\UserBanListResponse', []),
     ...
     */
    public function listUserBansRequest($userId)
    {
        ...
        $resourcePath = '/users/{user_id}/bans';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
