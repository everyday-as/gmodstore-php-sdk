...
class AddonCouponsApi
{
     ...
     */
    public function createAddonCouponRequest($addonId, $addonCoupon, $with = null)
    {
        ...
        if (isset($addonCoupon)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($addonCoupon));
            } else {
                $httpBody = $addonCoupon;
            }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteAddonCouponRequest($addonId, $couponId)
    {
        // verify the required parameter 'addonId' is set
        if ($addonId === null || (is_array($addonId) && count($addonId) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getAddonCouponRequest($addonId, $couponId, $with = null)
    {
        // verify the required parameter 'addonId' is set
        if ($addonId === null || (is_array($addonId) && count($addonId) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listAddonCouponsRequest($addonId, $with = null)
    {
        // verify the required parameter 'addonId' is set
        if ($addonId === null || (is_array($addonId) && count($addonId) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateAddonCouponRequest($addonId, $couponId, $addonCoupon, $with = null)
    {
        // verify the required parameter 'addonId' is set
        if ($addonId === null || (is_array($addonId) && count($addonId) === 0)) {
            throw new \InvalidArgumentException(
