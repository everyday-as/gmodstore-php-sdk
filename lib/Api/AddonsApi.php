...
class AddonsApi
{
    ...
    public function getAddonWithHttpInfo($addonId, $with = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Everyday\GmodStore\Sdk\Model\AddonResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Everyday\GmodStore\Sdk\Model\AddonResponse', []),
     ...
     */
    public function getAddonRequest($addonId, $with = null)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listSelfAddonsRequest($with = null)
    {
