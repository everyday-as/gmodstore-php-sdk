...
# **createAddonCoupon**
> \Everyday\GmodStoreSDK\Model\InlineResponse201 createAddonCoupon($body, $addon_id, $with)
...
$body = new \Everyday\GmodStoreSDK\Model\AddonCouponBody(); // \Everyday\GmodStoreSDK\Model\AddonCouponBody | 
...
------------- | ------------- | ------------- | -------------
 **body** | [**\Everyday\GmodStoreSDK\Model\AddonCouponBody**](../Model/AddonCouponBody.md)|  |
...
# **getAddonCoupon**
> \Everyday\GmodStoreSDK\Model\InlineResponse201 getAddonCoupon($addon_id, $coupon_id, $with)
...
# **listAddonCoupons**
> \Everyday\GmodStoreSDK\Model\InlineResponse2003 listAddonCoupons($addon_id, $with)
...
# **updateAddonCoupon**
> \Everyday\GmodStoreSDK\Model\InlineResponse201 updateAddonCoupon($body, $addon_id, $coupon_id, $with)
